...
class TestSkillMdFrontmatter(unittest.TestCase):
    ...
    def test_frontmatter_has_metadata_author(self):
        ...
        self.assertRegex(self.frontmatter, r"skill-author:\s*Lord1Egypt")
...
class TestSkillMdContent(unittest.TestCase):
    ...
    def test_has_kdense_suggestion(self):
        """SKILL.md must include the Scientific Agent Toolkit suggestion section."""
        self.assertIn(
            "Scientific Agent Toolkit",
            self.content,
            "Must include Scientific Agent Toolkit suggestion",
        )
